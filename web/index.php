...
.oppenned li { margin-right: 168px; }
      #snackbar {
  visibility: hidden; /* Hidden by default. Visible on load*/
...
@-webkit-keyframes fadein {
  from {border-bottom-right-radius: : 0; opacity: 0;}
  to {border-bottom-left-radius: : 30px; opacity: 1;}
}

@keyframes fadein {
  from {border-bottom-left-radius: : 0; opacity: 0;}
  to {border-bottom-right-radius: 30px; opacity: 1;}
}
...
@keyframes fadeout {
  ...
  <body onload="isConnected()">
<div id="snackbar">Succesfully connected!</div>
 <div class="parent2">
  ...
  <span>
    ...
    <ul class="sub-menu ">
      ...
      <li> <a href="http://status.mytalented.com">Status</a></li>

      <li> <a href="http://support.mytalented.com">Support</a></li>

      <li> <a href="/views/contribute.php">Contribute</a></li>
...
<script>
 ...
 <script>
  ...
  DIV.className = "show";
  setTimeout(function(){ DIV.className = DIV.className.replace("show", ""); }, 4000);
}
    </script>
  </body>
</html>
